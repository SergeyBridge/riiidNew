...
c.NotebookApp.custom_display_url = f'http://{ip}:7000'
...
## (sec) Time window used to  check the message and data_handle rate limits.
...
#  be in your Jupyter data_handle directory. You can set it to ':memory:' to disable
